package view;
public class modesWIN extends javax.swing.JFrame {

    private tablero tableroSudoku;
    private int xPos;
    private int yPos;
    public modesWIN(tablero tableroSudoku) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton3.setFont(new java.awt.Font("Franklin Gothic Medium Cond", 0, 14)); // NOI18N
        jButton3.setForeground(new java.awt.Color(255, 255, 255));
        jButton3.setText("Deficíl");
